    ...
    def model_fn(features, labels, mode, params):
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            # def metric_fn(label_ids, logits):
                ...
                precision = tf_metrics.precision(label_ids,predictions,8,[1,2],average="macro")
                recall = tf_metrics.recall(label_ids,predictions,8,[1,2],average="macro")
                f = tf_metrics.f1(label_ids,predictions,8,[1,2],average="macro")
                #
                return {
