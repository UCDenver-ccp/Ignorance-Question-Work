...
class NerProcessor(DataProcessor):
    ...
    def get_labels(self):
        return ['B', 'I', 'O-', 'I-PC', 'B-PU-PC', 'O-AOC', 'I-DT', 'B-FU-IE', 'I-PU', 'O-FU', 'O-FW', 'O-SR', 'I-QABTW', 'B-ACF', 'I-FW', 'O-IE', 'I-AOC', 'B-AOC-DT', 'O-PC', 'I-IE-QABTW', 'I-IE', 'I-ACF-AOC', 'B-FP', 'B-IE', 'B-DT', 'B-FU', 'I-SR', 'B-QABTW', 'B-FW', 'O-DT', 'B-EQ', 'B-PC', 'O-PU', 'I-FP', 'B-ACF-AOC', 'I-FW-IC', 'I-FU', 'B-AOC', 'I-ACF', 'I-SR-PC', 'O-QABTW', 'O', 'B-SR', 'I-IC', 'B-PU', 'O-ACF', 'B-FP-AOC', 'B-IC', 'X', "[CLS]", "[SEP]"]
...
def create_model(bert_config, is_training, input_ids, input_mask,
    ...
    with tf.variable_scope("loss"):
        ...
        logits = tf.reshape(logits, [-1, FLAGS.max_seq_length, 52])
    ...
    def model_fn(features, labels, mode, params):
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            def metric_fn(per_example_loss, label_ids, logits):
                ...
                precision = tf_metrics.precision(label_ids, predictions, 52, [1, 2], average="macro")
                recall = tf_metrics.recall(label_ids, predictions, 52, [1, 2], average="macro")
                f = tf_metrics.f1(label_ids, predictions, 52, [1, 2], average="macro")
                #
                return {
