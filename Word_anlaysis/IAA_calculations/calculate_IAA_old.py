...
def collect_annotations(annotation_path, article, all_lc_it_dict, span_overlap_score_dict):
    ...
    return annotation_article_dict, span_overlap_score_dict
...
if __name__ == '__main__':
    ...
    articles = ['PMC4973215', 'PMC5539754'] #5/2/21 - ontology 4.21.21
    # articles = ['PMC5658906'] #5/7/21 - ontology 5.2.21
    # articles = ['PMC3271033'] #5/14/21 - ontology 5.9.21
    # articles = ['PMC5405375'] #5/21/21 - ontology 5.14.21
    ...
    annotators_KATIE = ['KATIE', 'KATIE_MAYLA']
    all_annotation_paths_KATIE = [annotation_path_Katie, annotation_path_gold_standard_v2]

    annotators_STEPHANIE = ['STEPHANIE', 'STEPHANIE_MAYLA']
    all_annotation_paths_STEPHANIE = [annotation_path_Stephanie, annotation_path_gold_standard_v2]
    ...
    ##2 files for annotation separately
    all_combos_IAAs = [(0, 1)]
        ...
        for c in all_combos_IAAs:
            ...
            for article in articles:
                ...
                for i in range(len(c)):
                    ...
                    annotation_article_dicts, span_overlap_score_dict = collect_annotations(all_annotation_paths[c[i]], article, all_lc_it_dict, span_overlap_score_dict)
